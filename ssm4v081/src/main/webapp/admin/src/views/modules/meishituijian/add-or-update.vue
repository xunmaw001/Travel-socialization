    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食物名称" prop="shiwumingcheng">
          <el-input v-model="ruleForm.shiwumingcheng" 
              placeholder="食物名称" clearable  :readonly="ro.shiwumingcheng"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="食物简介" prop="shiwujianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="食物简介"
                  v-model="ruleForm.shiwujianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiwujianjie" label="食物简介" prop="shiwujianjie">
                    <span>{{ruleForm.shiwujianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `meishituijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meishituijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
