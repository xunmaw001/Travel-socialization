    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="分享内容" prop="fenxiangneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fenxiangneirong" label="分享内容" prop="fenxiangneirong">
                    <span>{{ruleForm.fenxiangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fenxiangquan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fenxiangquanCrossAddOrUpdateFlag = false;
                  this.parent.search();
