<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="周边名称" prop="zhoubianmingcheng">
          <el-input v-model="ruleForm.zhoubianmingcheng" 
              placeholder="周边名称" clearable  :readonly="ro.zhoubianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="周边名称" prop="zhoubianmingcheng">
              <el-input v-model="ruleForm.zhoubianmingcheng" 
                placeholder="周边名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdiandizhi = true;
          ...
          if(o=='zhoubianmingcheng'){
            this.ruleForm.zhoubianmingcheng = obj[o];
	    this.ro.zhoubianmingcheng = true;
            continue;
          }
          if(o=='tupian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhoubiantuijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhoubiantuijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
