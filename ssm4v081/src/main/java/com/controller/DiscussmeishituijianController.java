...
public class DiscussmeishituijianController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussmeishituijianEntity discussmeishituijian, HttpServletRequest request){
        EntityWrapper<DiscussmeishituijianEntity> ew = new EntityWrapper<DiscussmeishituijianEntity>();
		PageUtils page = discussmeishituijianService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussmeishituijian), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussmeishituijianEntity> wrapper = new EntityWrapper<DiscussmeishituijianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussmeishituijianService.selectCount(wrapper);
