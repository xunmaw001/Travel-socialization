...
public class JingdiantuijianEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JingdiantuijianEntity() {
		
	}
	
	public JingdiantuijianEntity(T t) {
		try {
	 ...
	 * 设置：景点类别
	 */
	public void setJingdianleibie(String jingdianleibie) {
		this.jingdianleibie = jingdianleibie;
	}
	/**
	 * 获取：景点类别
	 */
	public String getJingdianleibie() {
		return jingdianleibie;
	}
	/**
	 * 设置：景点地址
	 */
